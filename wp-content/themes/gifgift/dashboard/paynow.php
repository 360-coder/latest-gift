...
//$platformName = 'gifgift'; // RaaS v2 API Platform Name
//$platformKey = 'FvAkqDvYdaHPEfDAWU$osUG?QEDzpDEeVxlEMgInsAW'; // RaaS v2 API Platform Key previous
...
<?php $wp_session = WP_Session::get_instance();
  $card_id = $wp_session['gift_data']['card_id'];
  //echo "<pre>"; print_r($card_id);
 if($_POST['gif2data']){
...
//$body = new RaasLib\Models\CreateOrderRequestModel('shaanaksh5',$original_amount,'shaanakshtest3','false',$card_id,null,'Create Order',null,'Testing Order',null,null,null);
...
/*$body = new RaasLib\Models\CreateOrderRequestModel('gifgiftaccount',$original_amount,'gifgift',false,$card_id,NULL,'Create New Order',NULL,'Testing New Order',NULL,NULL,NULL);
echo "<pre>"; print_r($body);
$result = $orders->createOrder($body);
echo "<pre>"; print_r($result).'<br/>';
$redempt = $result->reward->redemptionInstructions;
...
$redemption = 'Redemption Code : '. $reedem . '<br>'.$redempt;
echo "<pre>"; print_r($redemption);*/
      global $wpdb;
