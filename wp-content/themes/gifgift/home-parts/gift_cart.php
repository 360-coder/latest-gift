...
$platformName = 'gifgift'; // RaaS v2 API Platform Name Test
$platformKey = 'yOVufLQoFBKOsAfScBXkqNlImWVTTqU!?VNNVCxolaZvHmA'; 

//$platformName = 'gifgift'; // RaaS v2 API Platform Name
//$platformKey = 'DtVQvvkHlZogP&nGMhnaDFslrlCxKCDpyNm@QcwLkAq'; 
...
<?php //echo $card_disclaimers; ?>	
		...
		<?php if($card_disclaimers != 'B891734'){ ?>	
